...
CREATE TABLE empleado (
  ...
  CONSTRAINT fk_empleado_codigo_empleado FOREIGN KEY (codigo_jefe) REFERENCES empleado (codigo_empleado)
);
...
CREATE TABLE detalle_pedido (
  ...
  CONSTRAINT pk_detalle_pedido_codigos PRIMARY KEY (codigo_pedido, codigo_producto),
...
CREATE TABLE pago (
  ...
  CONSTRAINT pk_pago_codigo_idtransaccion PRIMARY KEY (codigo_cliente, id_transaccion),
  CONSTRAINT fk_pago_codigo_cliente FOREIGN KEY (codigo_cliente) REFERENCES cliente (codigo_cliente)
);

-- Datos
INSERT INTO oficina VALUES ('BCN-ES','Barcelona','España','Barcelona','08019','+34 93 3561182','Avenida Diagonal, 38','3A escalera Derecha'),('BOS-USA','Boston','EEUU','MA','02108','+1 215 837 0825','1550 Court Place','Suite 102'),('LON-UK','Londres','Inglaterra','EMEA','EC2N 1HN','+44 20 78772041','52 Old Broad Street','Ground Floor');
